        ...
        <div id="projects" className="container my-5 grid" >
            ...
            <main className="page-content-projects my-5">
                <div className="projectBox" data-aos="fade-up">
                    <img src='/images/fieldr.png' className='img-fluid mb-4' alt='fleidr' />
                    <h4>FieldR</h4>
                    <p className="copy">(MERN Stack - Inprogress) <br /> Online cricket analytics and digital score sheet mobile app.</p>
                    <Button
                        href="https://community.fieldr.lk"
                        target='_blank'
                        variant="contained"
                ...
                <div className="projectBox" data-aos="fade-up" data-aos-delay="200">
                    <img src='/images/sling.png' className='img-fluid mb-4' alt='slingmobility' />
                    <h4>slingmobility.com</h4>
                    <p className="copy">(React Typescript Serverless) <br /> Affordable and innovative 360 degree EV solutions and fleet management.</p>
                    <Button
                ...
                <div className="projectBox" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <p className="copy">(React Typescript Serverless) <br /> Aenigme provides digital strategies for products & small and medium enterprises.</p>
                    <Button
